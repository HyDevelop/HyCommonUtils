...
```gradle
dependencies {
    implementation 'com.github.hydevelop:HyCommonUtils:1.3.5.134'
}
```

#### [其他导入(SBT / Leiningen)](https://jitpack.io/#hydevelop/HyCommonUtils/1.3.5.134)
